...
class SettingsScreen extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) => Scaffold(appBar: AppBar(title: const Text('Beállítások')), body: ListView(padding: const EdgeInsets.all(16), children: [FilledButton.icon(onPressed: () => _showExport(context), icon: const Icon(Icons.upload), label: const Text('JSON export')), const SizedBox(height: 12), OutlinedButton.icon(onPressed: () => _showImport(context), icon: const Icon(Icons.download), label: const Text('JSON import'))]));
